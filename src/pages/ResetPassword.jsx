...
export default function ResetPassword() {
  ...
  // Supabase turns the emailed reset link into a "recovery" session automatically
  // (the SDK reads the token from the URL on load), so we just wait for that
  // session to be established rather than parsing a token ourselves.
